...
describe('API V2 tests:', function(){
  ...
  describe('Get one reading', function(){
    it('Returns database in body, wihtout errors.', function(done){
      var apiResponse = {};
      request('http://localhost:3000/api/v2/oneReading', function(error, response, body) {
        ...
        assert(apiResponse.body && !error, 'Missing body or recieved an error response.');
        done();
      })
    });
  }),
